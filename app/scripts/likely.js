  ...
  var h = "likely",
    ...
    v = {
      ...
      vkontakte: {
        ...
        counterUrl: u + "//vk.com/share.php?act=count&url={url}&index={index}",
        ...
        popupUrl: u + "//vk.com/share.php?url={url}&title={title}",
        popupWidth: 550,
        popupHeight: 330
      },
      gplus: {
        ...
        counterUrl: "http:" === u ? "http://share.yandex.ru/gpp.xml?url={url}" : e,
        counter: function(e, i) {
          var n = v.gplus;
      ...
      pinterest: {
        ...
        popupUrl: u + "//pinterest.com/pin/create/button/?url={url}&description={title}",
        popupWidth: 630,
        popupHeight: 270
      }
    },
